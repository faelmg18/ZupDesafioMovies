...
import com.br.desafiozup.database.annotation.TableName;
...
public abstract class BaseDAO<T extends EntitiePersistable> extends BaseDAOReflection<T> {
    ...
    public long saveOrUpdate(T entitie) throws AndroidDataBaseException {
        long result = 0;
        try {
    ...
    public T getElementRawQuery(String selectQuery, String[] selectionArgs) throws AndroidDataBaseException {
        throwExceptionIfIsAIncorretQuery(selectQuery);
        boolean returnAllColumns = hasToReturnAllColumns(selectQuery);
